...
const zhCN = {
    ...
    components: {
        ...
        update: {
            title: '发现新版本',
            intro: 'Gray Code v{version} 已发布，请前往「设置 → 通用 → 自动更新」选择版本并手动完成更新。',
            releaseNotes: '更新内容',
            install: '下载并安装',
            later: '稍后再说',
        ...
        settings: {
            ...
            settingsPanel: {
                ...
                update: {
                    title: '自动更新',
                    description: '启动时检查 GitHub Releases 是否有新版本（24 小时内不重复检查），发现新版可下载更新包手动更新。',
                    enableLabel: '启用自动检查更新',
                    kindLabel: '下载版本',
                    kindAuto: '自动（跟随当前运行形态）',
                    kindPortable: '便携版（GrayCode-Portable）',
                    kindInstalled: '安装版（GrayCode.Setup）',
                    kindHint: '选择下载的更新包形态；「自动」按当前运行形态匹配（便携版下便携版、安装版下安装版）。',
                    kindChanged: '下载版本已切换，请点击「立即检查」按新选择重新匹配更新包。',
                    checkNow: '立即检查',
                    updateNow: '下载更新包',
                    checking: '检查中…',
                    upToDate: '已是最新版本',
                    updateAvailable: '发现新版本 v{version}',
                    installedHint: 'v{version} 更新包已下载到：{path}。请手动完成接下来的更新流程（便携版运行 GrayCode-Portable 安装包，安装版运行 GrayCode.Setup 安装包）。',
                    error: '检查失败',
