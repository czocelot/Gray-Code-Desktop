...
const en: LanguageMessages = {
    ...
    components: {
        ...
        update: {
            ...
            intro: 'Gray Code v{version} is available. Go to Settings → General → Auto Update to pick a version and update manually.',
                   releaseNotes: 'What\'s New',
            install: 'Download & Install',
            later: 'Later',
            viewPage: 'View on GitHub',
            goToSettings: 'Go to Update Settings',
        ...
        settings: {
            ...
            settingsPanel: {
                ...
                update: {
                    title: 'Auto Update',
                    description: 'Check GitHub Releases for new versions at startup (at most once every 24 hours). New versions can be downloaded and updated manually.',
                    enableLabel: 'Enable automatic update checks',
                    kindLabel: 'Download Version',
                    kindAuto: 'Auto (follow current runtime type)',
                    kindPortable: 'Portable (GrayCode-Portable)',
                    kindInstalled: 'Installer (GrayCode.Setup)',
                    kindHint: 'Choose which package to download; "Auto" matches the current runtime type (portable downloads portable, installed downloads installer).',
                    kindChanged: 'Download version changed. Click "Check Now" to re-match packages.',
                    checkNow: 'Check Now',
                    updateNow: 'Download Package',
                    checking: 'Checking…',
                    upToDate: 'Up to date',
                    updateAvailable: 'Update available: v{version}',
                    installedHint: 'v{version} package downloaded to: {path}. Please finish the update manually (run GrayCode-Portable for portable, or GrayCode.Setup for installer).',
                    error: 'Check failed',
