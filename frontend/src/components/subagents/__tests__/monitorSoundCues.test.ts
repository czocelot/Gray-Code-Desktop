...
describe('monitorSoundCues 子代理提示音规则', () => {
  ...
  describe('playMonitorSubagentCue', () => {
    test('以 role: subagent 转发给音效控制器，未传时间戳时使用当前时间', () => {
